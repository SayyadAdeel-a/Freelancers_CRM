  ...
  return (
    <div className="animate-in fade-in zoom-in duration-400">
      ...
      <div className="flex flex-col items-center gap-4">
        ...
        <p className="text-[10px] font-bold tracking-wider text-muted-foreground bg-accent border border-border px-3 py-1 rounded-sm font-mono uppercase">Free forever — up to 25 clients on the free plan</p>
      </div>
    </div>
  );
}
